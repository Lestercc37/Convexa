...
def gamma_aggregate_response(gamma: GammaAggregate) -> dict[str, Any]:
    return {
        ...
        "view": gamma.view,
        "has_data": bool(gamma.items),
        "gamma_flip": _optional_num(gamma.gamma_flip),
...
def gamma_response(
    ...
    response = {
        ...
        "has_data": bool(gamma.items),
        "gamma_flip": _optional_num(gamma.gamma_flip),
        "call_wall": _optional_num(gamma.call_wall),
        "put_wall": _optional_num(gamma.put_wall),
        "absolute_gamma_strike": _num(gamma.absolute_gamma_strike),
        "max_pain": _num(gamma.max_pain),
        ...
        "delta_exposure": _num(gamma.delta_exposure),
