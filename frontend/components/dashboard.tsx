...
export function Dashboard() {
  ...
  // "1m" -- Lester's explicit call: the default stays 1-minute candles,
  // not 5m. PriceChart's own minBarSpacing is the structural guard
  // against unreadable compressed candles regardless of timeframe; the
  // user can already switch to 5m/15m/1h manually whenever they want a
